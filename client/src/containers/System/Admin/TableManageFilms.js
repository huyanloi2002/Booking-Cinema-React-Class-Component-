...
import './TableManagePost.scss'
import * as actions from '../../../store/actions'
import { LANGUAGES } from '../../../utils'

class TableManageFilms extends Component {
...
const mapDispatchToProps = dispatch => {
    return {
        // fetchAllFilmsRedux: () => dispatch(actions.fetchAllFilmsStart()),
        loadAllFilm: () => dispatch(actions.fetchAllFilms()),
        deleteAFilmRedux: (id) => dispatch(actions.deleteAFilm(id))
    };
};

export default connect(mapStateToProps, mapDispatchToProps)(TableManageFilms);
