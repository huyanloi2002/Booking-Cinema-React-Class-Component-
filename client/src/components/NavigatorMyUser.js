...
class NavigatorMyUser extends Component {
    state = {
        expandedMenu: {}
    };
...
export default withRouterInnerRef(connect(mapStateToProps, mapDispatchToProps)(NavigatorMyUser));
